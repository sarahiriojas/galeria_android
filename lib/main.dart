...
class MiagendaApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(debugShowCheckedModeBanner: false, title: "galeria fotografica", home: new PaginaPrincipal(title: "Galeria de imagenes Katia Riojas")); //fin de materialapp return
...
class PaginaPrincipalState extends State<PaginaPrincipal> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        backgroundColor: Color(0xffF1913C),
